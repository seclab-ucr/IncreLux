...
private:
    ...
    std::set<std::string> ioWhiteList;
    std::set<std::string> oobWhiteList;
...
public:
    ...
    void addIOWL(std::string str) {ioWhiteList.insert(str);}
    std::set<std::string> getIOWL(){return ioWhiteList;}

    void addOOBWL(std::string str) {oobWhiteList.insert(str);}
    std::set<std::string> getOOBWL(){return oobWhiteList;}
...
public:
    ...
    void addToIOWL(NodeIndex i, std::string bb) {
        nodes.at(i).addIOWL(bb);
    }
    std::set<std::string> getIOWL(NodeIndex i) {
        return nodes.at(i).getIOWL();
    }
    void addToOOBWL(NodeIndex i, std::string bb) {
        nodes.at(i).addOOBWL(bb);
    }
    std::set<std::string> getOOBWL(NodeIndex i) {
        return nodes.at(i).getOOBWL();
    }
